...
class ndcuray:
    ...
    def __init__(self,
        ...
        if not cp:
            raise RuntimeError('Cannot create a ndcuray as no CuPy installation available.')

        self._array = array # cp.array
        self.flags = ndcurayFlags(array, writeable)
    ...
    @property
    def base(self) -> tp.Optional[ndcuray]:
        b = self._array.base
        if b is None:
            return None
        return ndcuray(b)
    ...
    @property
    def data(self) -> tp.Optional[ndcuray]:
        return ndcuray(self._array.data)
    ...
    @property
    def imag(self) -> ndcuray:
        return ndcuray(self._array.imag)
    ...
    @property
    def real(self) -> ndcuray:
        return ndcuray(self._array.real)
    ...
    def __abs__(self) -> ndcuray:
        return ndcuray(self._array.__abs__())

    def __add__(self, value, /) -> ndcuray:
        return ndcuray(self._array.__add__(value))

    def __and__(self, value, /) -> ndcuray:
        return ndcuray(self._array.__and__(value))
    ...
    def __copy__(self):
        return ndcuray(self._array.__copy__())

    def __deepcopy__(self, memo):
        return ndcuray(self._array.__deepcopy__(memo))

    def __dir__(self) -> tp.List[str]:
        return self._array.__dir__()

    def __divmod__(self, value, /) -> tp.Tuple[ndcuray, ndcuray]:
        q, r = self._array.__divmod__(value)
        return ndcuray(q), ndcuray(r)
    ...
    def __eq__(self, value, /):
        return ndcuray(self._array.__eq__(value))

    def __float__(self) -> float:
        return self._array.__float__()

    def __floordiv__(self, value, /):
        return ndcuray(self._array.__floordiv__(value))

    def __format__(self):
        return self._array.__format__()

    def __ge__(self, value, /):
        return ndcuray(self._array.__ge__(value))
    ...
    def __gt__(self, value, /):
        return ndcuray(self._array.__gt__(value))

    def __iadd__(self, value, /):
        return ndcuray(self._array.__iadd__(value))

    def __iand__(self, value, /):
        return ndcuray(self._array.__iand__(value))

    def __ifloordiv__(self, value, /):
        return ndcuray(self._array.__ifloordiv__(value))

    def __ilshift__(self, value, /):
        return ndcuray(self._array.__ilshift__(value))

    def __imod__(self, value, /):
        return ndcuray(self._array.__imod__(value))

    def __imul__(self, value, /):
        return ndcuray(self._array.__imul__(value))

    def __int__(self) -> int:
        return self._array.__int__()

    def __invert__(self):
        return ndcuray(self._array.__invert__())

    def __ior__(self, value, /):
        return ndcuray(self._array.__ior__(value))

    def __ipow__(self, value, /):
        return ndcuray(self._array.__ipow__(value))

    def __irshift__(self, value, /):
        return ndcuray(self._array.__irshift__(value))

    def __isub__(self, value, /):
        return ndcuray(self._array.__isub__(value))
    ...
    def __iter__(self) -> tp.Iterator[tp.Any]:
        if self._array.ndim == 1:
            ...
            yield from (ndcuray(a) for a in self._array.__iter__())

    def __itruediv__(self, value, /):
        return ndcuray(self._array.__itruediv__(value))

    def __ixor__(self, value, /):
        return ndcuray(self._array.__ixor__(value))

    def __le__(self, value, /):
        return ndcuray(self._array.__le__(value))

    def __len__(self) -> int:
        return self._array.__len__()

    def __lshift__(self, value, /):
        return ndcuray(self._array.__lshift__(value))

    def __lt__(self, value, /):
        return ndcuray(self._array.__lt__(value))

    def __matmul__(self, value, /):
        return ndcuray(self._array.__matmul__(value))

    def __mod__(self, value, /):
        return ndcuray(self._array.__mod__(value))

    def __mul__(self, value, /):
        return ndcuray(self._array.__mul__(value))

    def __ne__(self, value, /):
        return ndcuray(self._array.__ne__(value))

    def __neg__(self):
        return ndcuray(self._array.__neg__())

    def __or__(self, value, /):
        return ndcuray(self._array.__or__(value))

    def __pos__(self):
        return ndcuray(self._array.__pos__())

    def __pow__(self, value, mod=None, /):
        return ndcuray(self._array.__pow__(value, mod))

    def __radd__(self, value, /):
        return ndcuray(self._array.__radd__(value))

    def __rand__(self, value, /):
        return ndcuray(self._array.__rand__(value))
    ...
    def __rfloordiv__(self, value, /):
        return ndcuray(self._array.__rfloordiv__(value))

    def __rlshift__(self, value, /):
        return ndcuray(self._array.__rlshift__(value))

    def __rmatmul__(self, value, /):
        return ndcuray(self._array.__rmatmul__(value))

    def __rmod__(self, value, /):
        return ndcuray(self._array.__rmod__(value))

    def __rmul__(self, value, /):
        return ndcuray(self._array.__rmul__(value))

    def __ror__(self, value, /):
        return ndcuray(self._array.__ror__(value))

    def __rpow__(self, value, mod=None, /):
        return ndcuray(self._array.__rpow__(value, mod))

    def __rrshift__(self, value, /):
        return ndcuray(self._array.__rrshift__(value))

    def __rshift__(self, value, /):
        return ndcuray(self._array.__rshift__(value))

    def __rsub__(self, value, /):
        return ndcuray(self._array.__rsub__(value))

    def __rtruediv__(self, value, /):
        return ndcuray(self._array.__rtruediv__(value))

    def __rxor__(self, value, /):
        return ndcuray(self._array.__rxor__(value))
    ...
    def __sub__(self, value, /):
        return ndcuray(self._array.__sub__(value))

    def __truediv__(self, value, /):
        return ndcuray(self._array.__truediv__(value))

    def __xor__(self, value, /):
        return ndcuray(self._array.__xor__(value))
    ...
    def argmax(self, axis=None, out=None, *, keepdims=False):
        return ndcuray(self._array.argmax(axis, out, keepdims=keepdims))

    def argmin(self, axis=None, out=None, *, keepdims=False):
        return ndcuray(self._array.argmin(axis, out, keepdims=keepdims))

    def argpartition(self, kth, axis=-1, kind='introselect', order=None):
        return ndcuray(self._array.argpartition(kth, axis, kind, order))

    def argsort(self, axis=-1, kind=None, order=None):
        return ndcuray(self._array.argsort(axis, kind, order))

    def astype(self,
            dtype,
            order='K',
            copy=True,
            ) -> tp.Union[ndcuray, np.ndarray]:
        dt = dtype if hasattr(dtype, 'kind') else np.dtype(dtype)

        if dt.kind in _DTYPE_KIND_CUPY:
            return ndcuray(self._array.astype(dt,
                    order=order,
                    copy=copy,
                    ))
    ...
    def choose(self, choices, out=None, mode='raise'):
        return ndcuray(self._array.choose(choices, out, mode))

    def clip(self, min=None, max=None, out=None, **kwargs):
        return ndcuray(self._array.clip(min, max, out, **kwargs))

    def compress(self, condition, axis=None, out=None):
        return ndcuray(self._array.compress(condition, axis, out))

    def conj(self):
        return ndcuray(self._array.conj())

    def conjugate(self):
        return ndcuray(self._array.conjugate())

    def copy(self, order='C'):
        return ndcuray(self._array.copy(order))

    def cumprod(self, axis=None, dtype=None, out=None):
        return ndcuray(self._array.cumprod(axis, dtype, out))

    def cumsum(self, axis=None, dtype=None, out=None):
        return ndcuray(self._array.cumsum(axis, dtype, out))

    def diagonal(self, offset=0, axis1=0, axis2=1):
        return ndcuray(self._array.diagonal(offset, axis1, axis2))
    ...
    def fill(self, value):
        return ndcuray(self._array.fill(value))

    def flatten(self, order='C'):
        return ndcuray(self._array.flatten(order))

    def item(self, *args):
        return self._array.item(*args)

    def max(self, axis=None, out=None, keepdims=False, initial=None, where=True):
        return ndcuray(self._array.max(axis, out, keepdims, initial, where))

    def mean(self, axis=None, dtype=None, out=None, keepdims=False, *, where=True):
        return ndcuray(self._array.mean(axis, dtype, out, keepdims, where=where))

    def min(self, axis=None, out=None, keepdims=False, initial=None, where=True):
        return ndcuray(self._array.min(axis, out, keepdims, initial, where))

    def nonzero(self):
        return ndcuray(self._array.nonzero())

    def partition(self, kth, axis=-1, kind='introselect', order=None):
        return ndcuray(self._array.partition(kth, axis, kind, order))

    def prod(self, axis=None, dtype=None, out=None, keepdims=False, initial=1, where=True):
        return ndcuray(self._array.prod(axis, dtype, out, keepdims, initial, where))

    def ptp(self, axis=None, out=None, keepdims=False):
        return ndcuray(self._array.ptp(axis, out, keepdims))

    def put(self, indices, values, mode='raise'):
        return ndcuray(self._array.put(indices, values, mode))

    def ravel(self, order):
        return ndcuray(self._array.ravel(order))

    def repeat(self, repeats, axis=None):
        return ndcuray(self._array.repeat(repeats, axis))

    def reshape(self, shape, *args, order='C'):
        return ndcuray(self._array.reshape(shape, *args, order=order))

    def round(self, decimals=0, out=None):
        return ndcuray(self._array.round(decimals, out))
    ...
    def squeeze(self, axis=None):
        return ndcuray(self._array.squeeze(axis))

    def std(self, axis=None, dtype=None, out=None, ddof=0, keepdims=False, *, where=True):
        return ndcuray(self._array.std(axis, dtype, out, ddof, keepdims, where=where))
    ...
    def swapaxes(self, axis1, axis2):
        return ndcuray(self._array.swapaxes(axis1, axis2))

    def take(self, indices, axis=None, out=None, mode='raise'):
        return ndcuray(self._array.take(indices, axis, out, mode))
    ...
    def trace(self, offset=0, axis1=0, axis2=1, dtype=None, out=None):
        return ndcuray(self._array.trace(offset, axis1, axis2, dtype, out))

    def transpose(self, *axes):
        return ndcuray(self._array.transpose(*axes))

    def var(self, axis=None, dtype=None, out=None, ddof=0, keepdims=False, *, where=True):
        return ndcuray(self._array.var(axis, dtype, out, ddof, keepdims, where=where))

    def view(self, dtype, type):
        return ndcuray(self._array.view(dtype, type))
